...
@Autonomous(name = "FourSpecNextNEWWW", group = "Autonomous")
public class FourSpecNextNEWWW extends PedroOpMode {
    public FourSpecNextNEWWW() {
    ...
    private final Pose pickupSpec1 = new Pose(7.5, 32, Math.toRadians(180));

    private final Pose scoreSpec = new Pose(36, 71, Math.toRadians(0));
    ...
    private PathChain scoreSpecimen1, block1, pushBlock1, block2, pushBlock2,
            scoreSpecimen2, prepSpec3, spec3, scoreSpecimen3;
