...
public class FourSpec extends OpMode {
    ...
    private final Pose scorePreload = new Pose(37.6, 60, Math.toRadians(0));

    /** Lowest (First) Sample from the Spike Mark */
    private final Pose moveBlock1 = new Pose(50, 42, Math.toRadians(180));
    ...
    /** Lowest (First) Sample from the Spike Mark */
    private final Pose moveBlock2 = new Pose(50, 32, Math.toRadians(180));
    ...
    private final Pose pickupSpec1 = new Pose(8.5, 18.62, Math.toRadians(180));
    ...
    private final Pose pickupSpec = new Pose(9.5, 42, Math.toRadians(180));
    ...
    public void buildPaths() {
        ...
        pushBlock2 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(moveBlock2), new Point(parkBlock2Control), new Point(pickupSpec1)))
                .setConstantHeadingInterpolation(moveBlock2.getHeading())
                .setPathEndTimeoutConstraint(300)
                .build();

        spec2 = follower.pathBuilder()
                .addPath(new BezierLine(new Point(parkBlock2), new Point(pickupSpec1)))
    ...
    public void slideKitUp() throws InterruptedException {
        ...
        robot.verticalSlideKit.setTargetPosition(-950);
    ...
    public void slideKitMid() throws InterruptedException {
        BruteForceRobot robot = new BruteForceRobot(hardwareMap);
        robot.verticalSlideKit.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        robot.verticalSlideKit.setTargetPosition(-900);
        robot.verticalSlideKit.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        robot.verticalSlideKit.setPower(-1);
        while (
                robot.verticalSlideKit.isBusy()
    ...
    public void slideKitDown() throws InterruptedException {
        ...
        robot1.verticalSlideKit.setTargetPosition(-1650);
        ...
        robot1.clawBackRotateRight.setPosition(0.925);
